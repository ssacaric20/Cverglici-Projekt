...
import foi.cverglici.core.data.api.RetrofitClient
import foi.cverglici.core.data.model.DishDetailsResponse
import kotlinx.coroutines.launch

/**
 * Fragment za prikaz detalja o jelu
 */
class DishDetailFragment : Fragment() {
    ...
    companion object {
        ...
        /**
         * Factory metoda za kreiranje fragmenta sa dish ID
         */
    ...
    private fun setupClickListeners() {
        ...
        // Favorite ikonica - samo vizualno, nema funkcionalnost
    ...
    /**
     * Učitaj detalje jela sa backenda
     */
    private fun loadDishDetails(dishId: Int) {
        lifecycleScope.launch {
            try {
                val response = RetrofitClient.authService.getDishDetails(dishId)
